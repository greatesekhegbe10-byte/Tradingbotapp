                ...
                <tr key={trade.id} className="border-b border-gray-700/50 hover:bg-gray-800/30 transition-colors">
                    ...
                    <td className="px-4 py-3 text-xs font-mono text-gray-400">
                      <div className="flex items-center gap-1">
                        <Shield className="w-3 h-3 text-danger" /> {trade.stopLoss?.toFixed(0)}
                      </div>
                      <div className="flex items-center gap-1 mt-0.5">
                        <Target className="w-3 h-3 text-success" /> {trade.takeProfit?.toFixed(0)}
                      </div>
                    </td>
                    <td className="px-4 py-3 text-gray-400">{trade.amount} BTC</td>
